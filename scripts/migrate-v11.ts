...
import { DEFAULT_LAYOUT_CONFIG } from "../src/lib/proposals/layout-config";
...
async function main() {
  ...
  await sql`
    ...
    SELECT 'Proposta Comercial K&N', 'proposta-comercial', 'proposta_comercial', ${JSON.stringify(DEFAULT_LAYOUT_CONFIG)}, true
